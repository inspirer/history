// ia32opc.cpp (full list of opcodes)
...
IA32::opcode_entry IA32::optab[] = 
{
	...
	{"fsubp",  1, 0xdee8, None, ShortForm, FloatReg, 0, 0}, // stX -= st0 ;pop
	...
	// MMX commands
	{"emms",   0, 0x0f77, None, Noth, 0, 0, 0},
	{"movd",   2, 0x0f6e, None, Modrm, MMXReg, Reg32|Mem32, 0},
	{"movd",   2, 0x0f7e, None, Modrm, Reg32|Mem32, MMXReg, 0},
...
IA32::reg_entry IA32::regtab[] = 
{
	...
	{"mm0",MMXReg,0}, {"mm1",MMXReg,1}, {"mm2",MMXReg,2}, {"mm3",MMXReg,3},
	{"mm4",MMXReg,4}, {"mm5",MMXReg,5}, {"mm6",MMXReg,6}, {"mm7",MMXReg,7},
	
	{"",0,0}
};

IA32::prefix_entry IA32::prefixtab[] = {
	{"lock", 0xf0},{"wait", 0x9b},
    {"rep",  0xf3},{"repe", 0xf3},
